package com.byteexpress.springboot.l2cache.web1;
...
public class SpringBootL2cacheWeb1Application {

	public static void main(String[] args) {
		SpringApplication.run(SpringBootL2cacheWeb1Application.class, args);
	}
